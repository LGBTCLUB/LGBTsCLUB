package com.lgbt.LGBTsCLUB.network.database;
...
public class SharedPrefsManager {
    public static final String PREF_NAME = "com.umeed";
    ...
    */
    ...
    public <M extends Model> void setObject(String key, List<LoginModel.LoginData> modelObject) {
